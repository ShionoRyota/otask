...
# 売上履歴（できれば一つにまとめたい）
  ...
  private
    ...
    def task_params
      params.require(:task).permit(:taskname, :number, :price, :order_number, :term, :remarks, :material_cost, :brokerage_fee, :processing_fee, :duration, :list_id, :user_id, thumbnails_attributes:[:images])
    end
end